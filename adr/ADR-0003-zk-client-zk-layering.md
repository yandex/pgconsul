...
**Тикет:** MDB-41956 (родительский: MDB-46662)
...
- **Связанные ADR:**
  ...
  - [ADR-0002](ADR-0002-exception-propagation-to-iteration-boundary.md) — стратегия распространения
...
- **Связанные тикеты:**
  - MDB-41956 — бизнес-слой для работы с ZK (родительский: MDB-46662)
