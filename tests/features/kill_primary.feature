Feature: Destroy primary in various scenarios
    ...
    Scenario: Destroy primary one by one with primary_switch_restart = no
        ...
        Then zookeeper "zookeeper1" has value "['pgconsul_new_primary_1.pgconsul_pgconsul_net', 'pgconsul_new_replica_1.pgconsul_pgconsul_net']" for key "/pgconsul/postgresql/durability_members"
